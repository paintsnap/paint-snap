...
import { PREMIUM_UPGRADE_URL, openUpgradePage } from "./lib/account-limits";
import AuthPage from "@/pages/auth-page";
import NotFound from "@/pages/not-found";
import { Home, Plus, Grid, LogOut, Camera, Mail, AlertTriangle, X, User, Settings, HelpCircle, Crown } from "lucide-react";
